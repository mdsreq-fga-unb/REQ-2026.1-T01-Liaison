# Desenvolvimento — Liaison

> Guia técnico para rodar o projeto localmente. Para **usar o app**, veja o [README](../README.md) ou acesse [liaison.gcsoftware.tech](https://liaison.gcsoftware.tech).
