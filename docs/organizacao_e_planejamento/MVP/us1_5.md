...
# [US1.5](index.md)
> **Edição de Perfil Institucional da Organização (RF05)**
...
|------|---------------------|
| **User Story** | US1.5 |
| **Requisito Funcional** | RF05 — Gerenciar perfil de Organização |
...
- RF05 (perfil da organização, US1.5) e RF04 (perfil do estudante, US1.4) são requisitos separados, mas compartilham a mesma base técnica e os mesmos valores de ICE. A complexidade está concentrada no frontend, com endpoints de CRUD simples no backend.
