...
# [US2.1](index.md)
> **Criação de Vagas de Voluntariado (RF21)**
...
|------|---------------------|
| **User Story** | US2.1 |
| **Requisito Funcional** | RF21 — Criar oportunidade |
...
## Dependências
- **Relacionada a:** #13 (Cadastro de Organizações — RF02/US1.2), #18 (Moderação de Organizações — RF07/US1.7)
- **Bloqueada por:** N/A (RF21 é item fundacional do CP02)
- **Bloqueia:** US2.2/#nova (Editar oportunidade — RF22), US2.3/#nova (Publicar oportunidade — RF23), US2.4/#nova (Encerrar oportunidade — RF24)

---

## Notas
- **ICE Score:** I=10 C=7 E=5 = 350 | **MoSCoW:** Must | **Quadrante:** Quick Win
- RF21 está no limiar Quick Win/Plan (E=5, ≈13h incluindo formulário multi-passo). Recomendação: fatiar em (1) modelo+endpoint, (2) formulário frontend, (3) validações+publicação.
- O campo `status` com choices (draft/active/paused/closed) é essencial para o fluxo de publicação (RF23) e encerramento (RF24).
- Não confundir "criação de vaga" (RF21) com "publicação de vaga" (RF23) — são issues separadas, com RF23 dependendo de RF21.
