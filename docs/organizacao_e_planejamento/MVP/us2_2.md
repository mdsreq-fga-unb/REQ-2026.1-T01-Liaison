...
# [US2.2](index.md)
> **Edição de Vagas de Voluntariado (RF22)**
...
|------|---------------------|
| **User Story** | US2.2 |
| **Requisito Funcional** | RF22 — Editar oportunidade |
...
## Dependências
- **Relacionada a:** #19 (Criação de Vagas — RF21/US2.1)
- **Bloqueada por:** #19 (RF21 — Criar oportunidade)
- **Bloqueia:** US2.3 (Publicação de Vagas — RF23), US2.4 (Encerramento de Vagas — RF24)

---

## Notas
- **ICE Score:** I=7 C=8 E=6 = 336 | **MoSCoW:** Must | **Quadrante:** Quick Win
- RF22 é um Quick Win que depende diretamente de RF21 (criação de vaga). Uma vez que o modelo e o formulário de criação estão implementados, a edição consiste em reutilizar os mesmos componentes com os dados pré-carregados.
