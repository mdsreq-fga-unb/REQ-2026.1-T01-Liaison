...
|------|---------------------|
| **User Story** | US2.9 |
| **Requisito Funcional** | RF12 — Cancelar candidatura |
...
## Descrição
Implementar a funcionalidade de cancelamento de candidatura pelo estudante. O estudante deve poder visualizar a lista de suas candidaturas vigentes e cancelar qualquer uma que ainda esteja aguardando avaliação da organização. Esta funcionalidade compõe o fluxo de cancelamento de candidaturas (RF12) e permite que o estudante mantenha seu painel de inscrições organizado e atualizado. O escopo é full-stack.
...
## Dependências
- **Relacionada a:** #22 (Candidatura — RF10/US2.7), #25 (Notificações — RF13/US2.10)
...
- RF12 (US2.9) é o cancelamento de candidatura. Trata-se de uma funcionalidade de implementação majoritariamente no backend, com complexidade controlada (E=6, ~6-8h).
- As notificações de status (US2.10 — RF13) são tratadas em issue separada (#25) por envolver complexidade distinta (notificações assíncronas).
