...
# [US3.2](index.md)
> **Registro de Frequência e Carga Horária (RF15)**
...
|------|---------------------|
| **User Story** | US3.2 |
| **Requisito Funcional** | RF15 — Registrar frequência |
...
## Dependências
- **Relacionada a:** #26 (Listagem de Aprovados — RF14/US3.1), #24 (Avaliação de Candidaturas — RF11/US2.8)
- **Bloqueada por:** #26 (RF14 — Listar aprovados)
- **Bloqueia:** #31 (Geração de Certificado — RF16/US3.3)

---

## Notas
- **ICE Score:** I=9 C=7 E=4 = 252 | **MoSCoW:** Must | **Quadrante:** Plan
- RF15 é classificada como Plan (E=4) devido à complexidade das validações de negócio e às exigências de imutabilidade. Recomendação: fatiar em (1) estrutura de dados e operação básica de registro, (2) validações de carga horária, (3) interface de registro no frontend.
...
- Este item pertence à cadeia longa de dependências que culmina em RF16 (emitir certificado). Atrasos nesta funcionalidade impactam toda a release R4.
