...
# [US3.4](index.md)
> **Exportação de Certificado Digital em PDF (RF17)**
...
|------|---------------------|
| **User Story** | US3.4 |
| **Requisito Funcional** | RF17 — Compartilhar certificado |
...
## Dependências
- **Relacionada a:** #31 (Geração de Certificado — RF16/US3.3), #34 (Download de Certificados — RF19/US3.6)
- **Bloqueada por:** #31 (RF16 — Emitir certificado)
- **Bloqueia:** N/A
...
- US3.4 (RF17) compartilha o mesmo ICE de US3.3 (RF16), pois ambas derivam do mesmo fluxo de certificação. A exportação é uma extensão natural da geração: uma vez que o PDF existe, baixá-lo é uma operação de leitura simples.
