...
| :--- | :--- |
| **Nome** | [ A DEFINIR ] |
| **Tipo** | Organização do terceiro setor (ONG / entidade social) |
| **Representante** | [ A DEFINIR ] |
| **Forma de contato** | Whatsapp, Google formulário, Microsoft Teams, Entrevistas presenciais, reuniões on-line quinzenais. |
...
*   **Problema das organizações:** ONGs e entidades sociais que dependem de voluntários não possuem, em geral, ferramentas para publicar vagas, receber inscrições, registrar presença e emitir comprovantes em um único sistema. O resultado é uso de canais fragmentados (WhatsApp, planilhas, e-mail), com perda de histórico e dificuldade de auditoria.

A partir dessa problemática, foi elaborado um Diagrama de Ishikawa, com o objetivo de identificar as principais causas da ineficiência na conexão entre esses atores, considerando aspectos relacionados a processos, tecnologia, pessoas, dados e validação institucional.

Nesse contexto, a oportunidade identificada reside na ausência de um mecanismo que facilite a comunicação com foco específico na conexão entre estudantes universitários e atividades de voluntariado com validação acadêmica. Com base em pesquisa inicial realizada pelo grupo, não foram identificadas soluções que integrem, em um único ambiente, o fluxo completo desde a descoberta da oportunidade até a emissão do certificado reconhecido pela instituição de ensino, o que representa alto potencial de inovação no contexto universitário.
...
| **ONGs e organizações sociais** | Cliente / usuário da plataforma | Recrutar voluntários qualificados; publicar e gerenciar atividades; controlar presença; comunicar-se com voluntários de forma organizada. | Alto |
...
| **Professores e tutores** | Interessado indireto | Acompanhar o envolvimento de estudantes em atividades extracurriculares; validar, quando aplicável, a participação como crédito acadêmico. | Baixo |
...
**Segmento 2 — Organizações do terceiro setor**
*   ONGs, fundações, associações comunitárias, asilos, abrigos de animais e projetos sociais de pequeno e médio porte que necessitam de voluntários recorrentes.
*   Organizações com baixa capacidade de investimento em ferramentas de gestão, que se beneficiaram de uma solução gratuita ou de baixo custo.
